...
public class CacheControlView implements View {
     ...
     */
    public static final CacheControlView forceCache(View view){
        return new Builder()
                .onlyIfCached()
    ...
    CacheControlView(Builder builder,View view) {
    ...
    public static final class Builder {
        ...
        public CacheControlView build(View view) {
            return new CacheControlView(this,view);
        }
    }
}
