...
import org.zoomdev.zoom.http.utils.BeanUtils;
...
public class Caster {
    ...
    static {
        ...
        Caster.registerParameterizedType(
                new MapperCasterFactory<Clob, List>() {
                    @Override
                    protected ValueCaster create(ParameterizedType javaType) {
    ...
    static class MapperStringCaster extends MapperCaster {
        ...
        MapperStringCaster(ParameterizedType javaType) {
            super(javaType);
        }
    ...
    static class MapperClobCaster extends MapperCaster {
        ...
        MapperClobCaster(ParameterizedType javaType) {
            super(javaType);
        }
    ...
    static abstract class MapperCaster implements ValueCaster {
        ...
        MapperCaster(ParameterizedType javaType) {
    ...
    private static abstract class ParameterizedTypeCasterfactory<SRC, DEST> {
        ...
        protected abstract ValueCaster create(ParameterizedType targetType);
    }
